 ...
 * @ORM\Table(name="attractions", uniqueConstraints={@ORM\UniqueConstraint(name="id_UNIQUE", columns={"id"})})
 * @ORM\Entity(repositoryClass="Admin\AdmBundle\Entity\Repositories\AttractionsRepository")
 */
class Attractions
{
    /**
