 ...
 * @ORM\Table(name="games_install", uniqueConstraints={@ORM\UniqueConstraint(name="id_UNIQUE", columns={"id"})})
 * @ORM\Entity(repositoryClass="Admin\AdmBundle\Entity\Repositories\GamesInstallRepository")
 */
class GamesInstall
{
    /**
