...
class CallUsers
{
     ...
     * @var \ListMessages
     *
     * @ORM\ManyToOne(targetEntity="Blogger\BlogBundle\Entity\ListMessages")
     * @ORM\JoinColumns({
     ...
     * Set longCall
     *
     * @param \Blogger\BlogBundle\Entity\ListMessages $longCall
     * @return CallUsers
     */
    public function setLongCall(\Blogger\BlogBundle\Entity\ListMessages $longCall = null)
    {
     ...
     * Get longCall
     *
     * @return \Blogger\BlogBundle\Entity\ListMessages 
     */
